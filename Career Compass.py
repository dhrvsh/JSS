...
def pageOneCanon():
    welcome.destroy()
    personalitySelect = customtkinter.CTk()
    ...
    abtLabel = customtkinter.CTkLabel(personalitySelect, text="Tell us about yourself:", fg_color="transparent", font=(font, 20))
    abtLabel.place(relx=0.09, rely=0.26, anchor=customtkinter.W)

    abtTXT = customtkinter.CTkTextbox(wrap=customtkinter.WORD, master=personalitySelect, font=(font, 16), width=410, height=205)
    abtTXT.place(relx=0.5, rely=0.31, anchor=customtkinter.N)

    def pageTwoCanon():
        about = abtTXT.get("0.0", "end")
        personalitySelect.destroy()
        ...
        chosenSubjs = customtkinter.CTkTextbox(wrap=customtkinter.WORD, master=subjSelect, height=192.5, width=310, font=(font, 14))
            ...
            def finalPage():
                try:
                    ...
                    if mathMarks > 100 or physMarks >100 or chemMarks >100 or bioMarks >100 or sstMarks >100 or compMarks >100:
                        ...
                        prompt = prompt+"\n"+about+"\nPlease suggest 10 suitable jobs for my future. I require no other informtion, just a plain list of jobs, each in a seperate line, nothing else. The list must not be numbered, nor bullet pointed. It must be simple text, in a simple list, only 10 jobs."
                        ...
                        def explain1():
                            ...
                            response = model.generate_content("Give me a short description for the job title: "+jobsList[1]+"\nNO FORMATTING, JUST PLAIN TEXT. JUST A PLAIN EXPLAINATION, NO INTRODUCTION. TRY TO GIVE IN POINTS.").text

                            jobsplainbox.configure(state="normal")
                            jobsplainbox.insert("0.0", "Job Title: "+jobsList[1]+"\n\n"+response)
                            jobsplainbox.configure(state="disabled")
                        ...
                        def explain2():
                            ...
                            response = model.generate_content("Give me a short description for the job title: "+jobsList[2]+"\nNO FORMATTING, JUST PLAIN TEXT. JUST A PLAIN EXPLAINATION, NO INTRODUCTION. TRY TO GIVE IN POINTS.").text

                            jobsplainbox.configure(state="normal")
                            jobsplainbox.insert("0.0", "Job Title: "+jobsList[2]+"\n\n"+response)
                            jobsplainbox.configure(state="disabled")
                        ...
                        def explain3():
                            ...
                            response = model.generate_content("Give me a short description for the job title: "+jobsList[3]+"\nNO FORMATTING, JUST PLAIN TEXT. JUST A PLAIN EXPLAINATION, NO INTRODUCTION. TRY TO GIVE IN POINTS.").text

                            jobsplainbox.configure(state="normal")
                            jobsplainbox.insert("0.0", "Job Title: "+jobsList[3]+"\n\n"+response)
                            jobsplainbox.configure(state="disabled")
                        ...
                        def explain4():
                            ...
                            response = model.generate_content("Give me a short description for the job title: "+jobsList[4]+"\nNO FORMATTING, JUST PLAIN TEXT. JUST A PLAIN EXPLAINATION, NO INTRODUCTION. TRY TO GIVE IN POINTS.").text

                            jobsplainbox.configure(state="normal")
                            jobsplainbox.insert("0.0", "Job Title: "+jobsList[4]+"\n\n"+response)
                            jobsplainbox.configure(state="disabled")
                        ...
                        def explain5():
                            ...
                            response = model.generate_content("Give me a short description for the job title: "+jobsList[5]+"\nNO FORMATTING, JUST PLAIN TEXT. JUST A PLAIN EXPLAINATION, NO INTRODUCTION. TRY TO GIVE IN POINTS.").text

                            jobsplainbox.configure(state="normal")
                            jobsplainbox.insert("0.0", "Job Title: "+jobsList[5]+"\n\n"+response)
                            jobsplainbox.configure(state="disabled")
                        ...
                        def explain6():
                            ...
                            response = model.generate_content("Give me a short description for the job title: "+jobsList[6]+"\nNO FORMATTING, JUST PLAIN TEXT. JUST A PLAIN EXPLAINATION, NO INTRODUCTION. TRY TO GIVE IN POINTS.").text

                            jobsplainbox.configure(state="normal")
                            jobsplainbox.insert("0.0", "Job Title: "+jobsList[6]+"\n\n"+response)
                            jobsplainbox.configure(state="disabled")
                        ...
                        def explain7():
                            ...
                            response = model.generate_content("Give me a short description for the job title: "+jobsList[7]+"\nNO FORMATTING, JUST PLAIN TEXT. JUST A PLAIN EXPLAINATION, NO INTRODUCTION. TRY TO GIVE IN POINTS.").text

                            jobsplainbox.configure(state="normal")
                            jobsplainbox.insert("0.0", "Job Title: "+jobsList[7]+"\n\n"+response)
                            jobsplainbox.configure(state="disabled")
                        ...
                        def explain8():
                            ...
                            response = model.generate_content("Give me a short description for the job title: "+jobsList[8]+"\nNO FORMATTING, JUST PLAIN TEXT. JUST A PLAIN EXPLAINATION, NO INTRODUCTION. TRY TO GIVE IN POINTS.").text

                            jobsplainbox.configure(state="normal")
                            jobsplainbox.insert("0.0", "Job Title: "+jobsList[8]+"\n\n"+response)
                            jobsplainbox.configure(state="disabled")
                        ...
                        def explain9():
                            ...
                            response = model.generate_content("Give me a short description for the job title: "+jobsList[9]+"\nNO FORMATTING, JUST PLAIN TEXT. JUST A PLAIN EXPLAINATION, NO INTRODUCTION. TRY TO GIVE IN POINTS.").text

                            jobsplainbox.configure(state="normal")
                            jobsplainbox.insert("0.0", "Job Title: "+jobsList[9]+"\n\n"+response)

                            jobsplainbox.configure(state="disabled")
                            
                            jobsplain.mainloop()
                        job1 = customtkinter.CTkButton(job, text=jobsList[0], font=(font, 14), height=50, width=225, command=explain0)
                        job1.place(relx=0.5, rely=0.035+0.15, anchor=customtkinter.CENTER)

                        job2 = customtkinter.CTkButton(job, text=jobsList[1], font=(font, 14), height=50, width=225, command=explain1)
                        job2.place(relx=0.5, rely=0.035+0.23, anchor=customtkinter.CENTER)

                        job3 = customtkinter.CTkButton(job, text=jobsList[2], font=(font, 14), height=50, width=225, command=explain2)
                        job3.place(relx=0.5, rely=0.035+0.31, anchor=customtkinter.CENTER)

                        job4 = customtkinter.CTkButton(job, text=jobsList[3], font=(font, 14), height=50, width=225, command=explain3)
                        job4.place(relx=0.5, rely=0.035+0.39, anchor=customtkinter.CENTER)

                        job5 = customtkinter.CTkButton(job, text=jobsList[4], font=(font, 14), height=50, width=225, command=explain4)
                        job5.place(relx=0.5, rely=0.035+0.47, anchor=customtkinter.CENTER)

                        job6 = customtkinter.CTkButton(job, text=jobsList[5], font=(font, 14), height=50, width=225, command=explain5)
                        job6.place(relx=0.5, rely=0.035+0.55, anchor=customtkinter.CENTER)

                        job7 = customtkinter.CTkButton(job, text=jobsList[6], font=(font, 14), height=50, width=225, command=explain6)
                        job7.place(relx=0.5, rely=0.035+0.63, anchor=customtkinter.CENTER)

                        job8 = customtkinter.CTkButton(job, text=jobsList[7], font=(font, 14), height=50, width=225, command=explain7)
                        job8.place(relx=0.5, rely=0.035+0.71, anchor=customtkinter.CENTER)

                        job9 = customtkinter.CTkButton(job, text=jobsList[8], font=(font, 14), height=50, width=225, command=explain8)
                        job9.place(relx=0.5, rely=0.035+0.79, anchor=customtkinter.CENTER)

                        job10 = customtkinter.CTkButton(job, text=jobsList[9], font=(font, 14), height=50, width=225, command=explain9)
    ...
    pageTwo = customtkinter.CTkButton(personalitySelect, text="Continue ⏭️", font=(font, 18), command=pageTwoCanon)
    pageTwo.place(relx=0.5, rely=0.875, anchor=customtkinter.CENTER)

    personalitySelect.mainloop()    

pageOne = customtkinter.CTkButton(welcome, text="Find your dream job!", command=pageOneCanon, font=(font, 14))
pageOne.place(relx=0.5, rely=0.6, anchor=customtkinter.CENTER)
